...
export class Command extends OC.Command {
  static override description =
    "Runs the CDK command to generate the AWS infrastructure resources for the suite in the current directory"
  ...
  async run() {
    ...
    return await (async () => {
      await runCdkStack({
        stackClassName: "SuiteInfrastructure",
        stackRole: "suite-infrastructure",
