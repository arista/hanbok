...
export class Command extends OC.Command {
  static override description = `Execute a prisma command for the database of one of the services, or for all of the services.  Specify the --service (if any), followed by "--", followed by the flags and arguments you wish to pass to prisma`
